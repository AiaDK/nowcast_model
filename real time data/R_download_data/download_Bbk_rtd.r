...
# In case if cmd says that there is no 'bundesbank' package, try installing the package via following...
  # install.packages("bundesbank", repos = "http://cran.us.r-project.org")
  # library(bundesbank)
